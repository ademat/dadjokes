  ...
  <div class="container">
    <div class="joke">
      <div class="joke__body">
        ...
        <p class="joke__text">{{jokeText}}</p>
      </div>
      <div class="joke__likes">
        <button id="btn-up" class="btn-like btn-like--up" @click="giveUpLike"></button>
        <span id="likes-up" class="likes-count likes-count--up">{{upLikes}}</span>
        <button id="btn-down" class="btn-like btn-like--down" @click="giveDownLike"></button>
...
export default {
  ...
  methods: {
    giveUpLike() {
      this.$emit("giveUpLike", this.idx);
    },
    giveDownLike() {
      this.$emit("giveDownLike", this.idx);
    }
  }
};
</script>
